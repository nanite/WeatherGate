...
public class FloatEditPanel extends ModalPanel {
    private final FloatTextBox valueBox;
    private final SimpleButton applyButton;
    private final SimpleButton cancelButton;
    private final Consumer<Float> onApply;

    public FloatEditPanel(Panel parent, float currentValue, Consumer<Float> onApply) {
        super(parent);
