...
public class LangProvider extends LanguageProvider {
    ...
    private void add(TerrainModifier<?> modifier, String name, String description) {
        add(modifier.id().toLanguageKey(), name);
        add(modifier.id().toLanguageKey() + ".info", description);
    }
}
