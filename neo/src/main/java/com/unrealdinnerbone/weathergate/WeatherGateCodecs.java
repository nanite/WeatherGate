...
public class WeatherGateCodecs
{
    ...
    public static final StreamCodec<ByteBuf, Color4I> COLOR4I_STREAM_CODEC = StreamCodec.of((byteBuf, color4I) -> byteBuf.writeInt(color4I.rgb()), byteBuf -> Color4I.rgb(byteBuf.readInt()));
    public static final StreamCodec<ByteBuf, Color4I> COLOR4I_ALPHA_STREAM_CODEC = StreamCodec.of((byteBuf, color4I) -> byteBuf.writeInt(color4I.rgba()), byteBuf -> Color4I.rgba(byteBuf.readInt()));
